...
<head>
    ...
    <%
        ...
        if (obj==null){
            response.sendRedirect(request.getContextPath()+"/home?opr=sel");
        }
    %>
...
<div class="i_bg bg_color">
    ...
    <div class="content">
        ...
        <div class="fresh_mid">
            <ul>
                <li>
                    <div class="name"><a href="#">荣耀4x</a></div>
                    <div class="price">
                        <font>￥<span>200000.00</span></font> &nbsp; 25R
                    </div>
                    <div class="img"><a href="#"><img src="images/tel_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">戴尔笔记本电脑</a></div>
                    <div class="price">
                        <font>￥<span>10000.00</span></font> &nbsp; 25R
                    </div>
                ...
                <li>
                    <div class="name"><a href="#">酷派手机</a></div>
                    <div class="price">
                        <font>￥<span>22000.00</span></font> &nbsp; 25R
                    </div>
                    <div class="img"><a href="#"><img src="images/tel_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">电子运动手环</a></div>
                    <div class="price">
                        <font>￥<span>9000.00</span></font> &nbsp; 25R
                    </div>
